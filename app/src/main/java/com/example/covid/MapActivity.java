...
public class MapActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener{
    ...
    public static final String API_KEY = "KakaoAK f633fabaa674a0042f15252f28f9b272" ; // REST API 키


//    private static final char listItems = arrayListOf<ListLayout>()   ;// 리사이클러 뷰 아이템
//    private static final char listAdapter = ListAdapter(listItems)  ;  // 리사이클러 뷰 어댑터
    private static final int pageNumber = 1 ;     // 검색 페이지 번호
//    private static final char keyword = ""   ;     // 검색 키워드
...
//        private static int retrofit = Retrofit.Builder() // retrofit 구성
//                .baseUrl(BASE_URL);
//    }
...
//        Toast.makeText(LocationDemoActivity.this, "Reverse Geo-coding : " + result, Toast.LENGTH_SHORT).show();
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        builder.setTitle("위치 서비스 비활성화");        builder.setMessage("앱을 사용하기 위해서는 위치 서비스가 필요합니다.\n"
                + "위치 설정을 수정하시겠습니까?");
